...
# Live dump: field is logoUrl.
# Ozon=logo_bank_ozon_ecom, T-Bank=logo_bank_tinkoff_v2, Alfa=logo_bank_alfabank.
# Alfa→Alfa phone history: «Переводы · Альфа-Банк» (no СБП), no bottomBadge.
