"""
Менеджер шаблонов VTB - автоматически выбирает шаблон с нужными буквами.
"""
...
CACHE_FILE = "templates/templates_cache.json"
...
def normalize_text(text: str) -> str:
    ...
    # Обычный дефис '-' заменяем на non-breaking hyphen '‑' (U+2011)
    # потому что в VTB PDF используется именно он
    return text.replace('-', '\u2011')
